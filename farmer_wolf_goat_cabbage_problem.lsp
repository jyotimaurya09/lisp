;;; Program to solve Farmer, Wolf, Goat and cabbage Problem
...
;;; The function "opposite" takes a side and returns the opposite side of the river.
...
(write (solve-fwgc '(w w w w) '(e e e e)))
